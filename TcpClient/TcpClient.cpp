...
int main() {
	...
	iResult = getaddrinfo("192.168.56.2", DEFAULT_PORT, &hints, &result);
	if (iResult != 0) {
	...
	//ServerAddr.sin_port = Port;		//Port
	//ServerAddr.sin_addr.S_un.S_addr = inet_addr("127.0.0.1"); //or get from user key-in.
