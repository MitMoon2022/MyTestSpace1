...
//int main()
//{
//    std::cout << "Start Weak Pointer from Nutcpp!\n";
...
struct Mother {
    ...
    std::weak_ptr<Son> mySon;           //must be declare as a weak_ptr
    std::weak_ptr<Daughter> myDaughter; //must be declare as a weak_ptr
};
