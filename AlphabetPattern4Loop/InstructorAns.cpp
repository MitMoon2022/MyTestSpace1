...
//
//Get the input from the userand store it in a std::string variable
//Loop for each letter in the string entered by the user
//Determine how many blank spaces must be displayed before the current rowand display them
//Determine how many letters must be displayed before the current characterand display them
